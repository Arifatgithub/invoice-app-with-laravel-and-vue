...
<head>
    <script src="{{ asset('frontend_assets') }}/assets/js/color-modes.js"></script>
    ...
    <link href="{{ asset('frontend_assets') }}/assets/css/app.css" rel="stylesheet">
    ...
    <link href="{{ asset('frontend_assets') }}/carousel.css" rel="stylesheet">
...
<body>
  ...
  ================================================== -->
            ...
            {{-- success message --}}
            <div class="px-4 pt-4 pb-0 alert" style="display: flex; flex-direction:column; align-items:flex-end">
                ...
                @endif
                {{-- error message --}}
                @if (session()->has('error') && session('error') == true)
